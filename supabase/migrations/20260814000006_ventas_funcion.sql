-- FASE 7: Ventas - secuencia de numeración + función atómica para registrar ventas
-- registrar_venta(p_items, p_moneda, p_descuento):
--   * valida el usuario autenticado y activo
--   * valida stock (no permite negativo)
--   * convierte precios a la moneda de la venta usando el tipo de cambio vigente
--   * guarda la venta con el tipo de cambio del momento
--   * inserta detalle_ventas, actualiza stock y registra movimientos tipo VENTA
-- Todo en una sola transacción. La ejecutan administradores y vendedores.
