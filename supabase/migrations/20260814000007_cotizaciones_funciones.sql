-- FASE 8: Cotizaciones
-- 1) Columna venta_id en cotizaciones (evita convertir dos veces / descontar stock dos veces)
-- 2) Secuencia de numeración de cotizaciones
-- 3) crear_cotizacion: guarda la cotización con el tipo de cambio del momento, no descuenta stock
-- 4) cambiar_estado_cotizacion: solo dueño o admin; impide cambios si ya fue convertida
-- 5) convertir_cotizacion_a_venta: crea la venta con los precios y tipo de cambio guardados,
--    descuenta stock una sola vez y registra movimientos VENTA.
